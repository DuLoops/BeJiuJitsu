...
const DropdownComponent = React.forwardRef<IDropdownRef, DropdownProps<any>>(
  (props, currentRef) => {
    ...
    // useEffect(() => {
    //     //Change from searchText to currentValue, Removing searchText
          ...
          {/* <View style={styles.dropdown}>
            ...
            {renderRightIcon ? (
              renderRightIcon(visible)
                ...
                <FontAwesome6 name="chevron-down" size={24} color="black" style={styles.icon}/>
            )}
          </View> */}
        </TouchableWithoutFeedback>
      );
